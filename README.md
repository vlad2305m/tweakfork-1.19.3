...
17. Selectively Visible Blocks -> Allows you to make nice replays/vids with transparent parts (~~works with Optifucked~~ NOT YET). Selectively renders blocks depending on position based white/blacklists.
