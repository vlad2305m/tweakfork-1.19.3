...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigInteger       RESTRICTION_LAYER_HEIGHT            = new ConfigInteger     ("restrictionLayerHeight", 1, 1, 1000, "The layer height for the layer restriction mode.\nTo quickly adjust the value, scroll while\nholding down the tweak toggle keybind.");
    ...
    public static class Disable
    {
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_SIDESCOREBOARD          = new ConfigBooleanHotkeyed("disableSideScoreboard",                false, "", "Disables sidebar scoreboard rendering");
