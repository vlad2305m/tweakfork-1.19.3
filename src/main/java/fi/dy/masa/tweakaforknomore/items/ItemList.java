package fi.dy.masa.tweakaforknomore.items;
...
import fi.dy.masa.tweakaforknomore.tweaks.RenderTweaks.ContainerEntry;
...
public class ItemList
{
    ...
    public boolean getScanToggle() {
        return FeatureToggleI.TWEAK_CONTAINER_SCAN().getBooleanValue();
    }

    public boolean getCountsRenderToggle() {
        return FeatureToggleI.TWEAK_CONTAINER_SCAN_COUNTS().getBooleanValue();
    }
    ...
    public void toggleCountsRender() {
        FeatureToggleI.TWEAK_CONTAINER_SCAN_COUNTS().toggleBooleanValue();
    }

    public void toggleScan() {
        FeatureToggleI.TWEAK_CONTAINER_SCAN().toggleBooleanValue();
    }
