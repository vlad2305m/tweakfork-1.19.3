...
19. Selectively Visible Blocks -> Allows you to make nice replays/vids with transparent parts (Doesnt work with optifucked). Selectively renders blocks depending on position based white/blacklists.
