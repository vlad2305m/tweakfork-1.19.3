...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    STACK_FLEXIBLE                  ("stackFlexible",                       false, "",    "If enabled, then flexible block placement rotation\nand offsets can be set independantly\ndespite holding both hotkeys"),
    ...
    TWEAK_HIDE_SCOREBOARD           ("tweakHideScoreboard",                 false, "",    "Hides the side scoreboard"),
    ...
    // TWEAK_SELECTIVE_BLOCKS          ("tweakSelectiveBlocks",                false, "",    "Enables selectively visible blocks");
