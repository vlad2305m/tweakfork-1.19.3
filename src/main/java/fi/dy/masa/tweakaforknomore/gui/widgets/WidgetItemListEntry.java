package fi.dy.masa.tweakaforknomore.gui.widgets;
...
import fi.dy.masa.tweakaforknomore.gui.Icons;
import fi.dy.masa.tweakaforknomore.items.ItemList;
import fi.dy.masa.tweakaforknomore.items.ItemList.SortCriteria;
...
public class WidgetItemListEntry extends WidgetListEntrySortable<ItemListEntry>
{
    private static final String[] HEADERS = new String[] {
            "tweakaforknomore.gui.label.item_list.title.item",
            "tweakaforknomore.gui.label.item_list.title.total",
            "tweakaforknomore.gui.label.item_list.title.boxes",
            "tweakaforknomore.gui.label.item_list.title.containers" };
    ...
    public WidgetItemListEntry(int x, int y, int width, int height, boolean isOdd,
            ItemList itemList, ItemListEntry entry, int listIndex, WidgetListItemList listWidget)
    {
        ...
        this.shulkerBoxAbbr = StringUtils.translate("tweakaforknomore.gui.label.item_list.abbr.shulker_box");
